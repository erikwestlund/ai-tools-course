...
Before the first class, students should complete the [Installation Instructions](docs/install-instructions/installation-instructions.html). In brief, students should:
