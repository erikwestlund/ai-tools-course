...
5. **Wrap-up principle**
   - Aim for a workflow that is persistent, inspectable, recoverable, and less annoying.
...
The craftsmanship lesson is that effective work often comes from arranging your environment so mistakes are cheaper, restarts are easier, and useful context stays available.
