...
This file is a small regional subset of the original tract-level source, intended for teaching tract-level spatial comparison, rank, and local variation without bundling the 828 MB raw file.
