...
* [Installation Instructions](docs/install-instructions/installation-instructions.html)
* [RStudio Repository Setup](docs/install-instructions/rstudio-repository-setup.html)
* [Positron Or VS Code Repository Setup](docs/install-instructions/positron-or-vs-code-repository-setup.html)
* [Other Software Repository Setup](docs/install-instructions/other-software-repository-setup.html)
* [Posit AI Setup](docs/install-instructions/posit-ai-setup.html)
...
- **Setup practice:** run `source("updater.R")`, open `practice/work/00_open-project-and-glimpse/`, and use the [prompt](practice/prompts/00_open-project-and-glimpse/prompt.txt)
- **Demo:** [First Agent Demo](modules/01_agent-demo/01_data-cleaning.qmd)
- **Practice:** run `source("updater.R")`, open `practice/work/01_clean-and-visualize/`, and use the [prompt](practice/prompts/01_clean-and-visualize/prompt.txt)
- **Assigned:** [Problem Set 1: Data Visualization](assignments/problem-set-1-data-visualization.html)

### Session 2 (Tuesday, June 16): Models, Privacy, And Harnesses

We will start hands-on with the clean-and-visualize practice, then step back to compare model types, local versus cloud deployment, API versus subscription billing, privacy constraints, and agent harnesses.

- Start with `practice/work/01_clean-and-visualize/`
- Model types, local versus cloud, and privacy
- API billing versus subscriptions
- Static demo walkthrough: [model and harness comparison](docs/model-harness-comparison/summary.html)
- Harnesses and tool permissions
- Start the modeling workflow after lecture

- **Slides:** [Session 2: Models, Privacy, And Harnesses](slides/02-session-2.html)
- **Start here:** run `source("updater.R")`, open `practice/work/01_clean-and-visualize/`, and use the [prompt](practice/prompts/01_clean-and-visualize/prompt.txt)
- **Demo reference:** [Model and harness comparison summary](docs/model-harness-comparison/summary.html)
- **Next practice:** run `source("updater.R")`, open `practice/work/02_modeling-workflow/`, and use the prompts in `practice/prompts/02_modeling-workflow/`
...
Before the first class, students should complete the [Installation Instructions](docs/install-instructions/installation-instructions.html): install Git if needed, install R/RStudio or Positron, install Quarto, and arrange access to at least one AI agent tool. RStudio users can follow the [RStudio Repository Setup](docs/install-instructions/rstudio-repository-setup.html); Positron or VS Code users can follow the [Positron Or VS Code Repository Setup](docs/install-instructions/positron-or-vs-code-repository-setup.html); other users can follow the [Other Software Repository Setup](docs/install-instructions/other-software-repository-setup.html). Posit AI users can follow the [Posit AI Setup](docs/install-instructions/posit-ai-setup.html). A GitHub account is only needed if your chosen AI tool requires it, such as GitHub Copilot.
