...
We will start with a condensed introduction to LLMs, why they are useful for statistical work, where they fail, and why structured workflows matter. We will compare chatbots, browser tools, GUI/IDE harnesses, and CLI harnesses on the same small task.

- [Slides](slides/01-foundations.html)
- [Prompt Template: Chat](demos/2-tools-introduction/source/02-tools-chat-template.html)
- [Prompt Template: Detailed](demos/2-tools-introduction/source/02-tools-detailed-template.html)
- [Prompt Template: Simple](demos/2-tools-introduction/source/02-tools-simple-template.html)
- **Practice:** Short synthetic-data task with no context, light context, and structured context.
...
* Model selection: cost, speed, reasoning behavior, coding ability, and cloud/local tradeoffs
* Agents: GUI/IDE workflows and CLI workflows
* Skill files and context files: documenting what good work looks like
* Structured practice: data preparation, visualization, and modeling on synthetic data

- [Slides](slides/02-tools-introduction.html)
- [Experiment: Comparing AI Tool Outputs on Maternal Health Data](demos/2-tools-introduction/summary.html)
- [Rendered Notebooks (all runs)](demos/2-tools-introduction/summary.html#rendered-notebooks)
- **Due before class:** Short course project topic proposal.

### Session 3 (Wednesday, June 17): Privacy, GitHub, and Sandbox Workflows

We will make privacy the capstone workflow. The day focuses on Git, GitHub, personal access tokens, and a two-repository sandbox simulation. One repository will simulate a restricted environment with pretend-sensitive data; another will simulate the AI-enabled development environment. We will practice moving code, metadata, schemas, and synthetic data across environments while keeping sensitive data out of external tools.

- [Slides](slides/03-tools-and-workflow.html)
- [Demos and Notebooks](demos/4-tools-and-workflow-index.html)
- [Git Push/Pull Bridge Demo](demos/5-git-push-pull/git-push-pull-bridge.html)
- [Two-Machine Synthetic Simulation Demo](demos/7-phi-two-machine/phi-two-machine-synthetic-simulated.html)
- **Due:** [Course project](course_docs/course-project.html): project materials and reflection; in-class share

## Pre-Work

Before the first class, students should create a GitHub account, install Git, install R/RStudio or Positron, install Quarto, and arrange access to at least one AI agent tool. We will create GitHub personal access tokens together during class.
