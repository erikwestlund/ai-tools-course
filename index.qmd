...
* [Pre-Class Setup Checklist](modules/00_installation-instructions.qmd)
...
- **Module:** Context Management (to be released)
- **Module:** Agent Differences Example (to be released)
- **Practice:** Context workflow (to be released)
...
Before the first class, students should complete the [Pre-Class Setup Checklist](modules/00_installation-instructions.qmd): install Git if needed, install R/RStudio or Positron, install Quarto, and arrange access to at least one AI agent tool. A GitHub account is only needed if your chosen AI tool requires it, such as GitHub Copilot.
