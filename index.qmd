...
* [Pre-Class Setup Checklist](modules/01_installation-instructions.html)
...
- **Demo:** [First Agent Demo](modules/01_agent-demo/01_data-cleaning.html)
- **Practice:** [Clean And Visualize](practice/tasks/01_clean-and-visualize/)
...
- **Module:** [Context Management](modules/02_context-management/index.html)
- **Module:** [Agent Differences Example](modules/03_agent-differences-example/index.html)
- **Practice:** [Modeling Workflow](practice/tasks/02_modeling-workflow/)
...
Before the first class, students should complete the [Pre-Class Setup Checklist](modules/01_installation-instructions.html): install Git if needed, install R/RStudio or Positron, install Quarto, and arrange access to at least one AI agent tool. A GitHub account is only needed if your chosen AI tool requires it, such as GitHub Copilot.
