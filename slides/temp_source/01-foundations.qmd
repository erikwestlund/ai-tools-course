...
A system can manipulate symbols perfectly and understand *nothing*. Syntax differs from semantics.
...
This training objective explains the "sophisticated autocomplete" label. At scale, the same objective can produce behavior that *looks like* reasoning on some tasks, while still remaining fragile.
