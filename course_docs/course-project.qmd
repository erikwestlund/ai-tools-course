...
subtitle: "AI Tools for Data Science and Statistics (140.697.79)"
date: last-modified
format:
  html:
    toc: true
...
**Due: June 16 (before Session 2)**

Submit a short description of your proposed moonshot task. A few sentences is fine. Describe what you want to attempt, what tools you expect to use, and what would count as useful progress.

### 2. Project and reflection

**Due: June 17 (Session 3)**
...
**Written reflection:** Your reflection must address:
...
### 3. In-class share (Session 3)

During Session 3, each student will give an informal 3-minute summary of their moonshot to the class. No slides required. We will discuss as a group after each share.

The project does not need to be "finished" by Session 3. Incomplete attempts with honest reflection are perfectly acceptable.
